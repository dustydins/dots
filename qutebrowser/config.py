...
config.bind(',,', 'set-mark ,')
config.bind(',.', 'jump-mark ,')
config.bind(',m', 'hint links spawn umpv {hint-url}')
config.bind(',M', 'spawn umpv {url}')
config.bind(';m', 'hint --rapid links spawn umpv {hint-url}')

config.bind(',z', 'hint links spawn --userscript qute-pdf-viewer {hint-url}')
config.bind(';z', 'hint --rapid links spawn --userscript qute-pdf-viewer {hint-url}')

config.bind(',p', 'spawn --userscript qute-lastpass')
config.bind('xb', 'config-cycle statusbar.hide False True')
config.bind('xt', 'config-cycle tabs.show always never')
config.bind('xx', 'config-cycle tabs.show always never;; config-cycle statusbar.hide False True')

# theme cycle
config.bind(',ap', 'config-cycle content.user_stylesheets ~/opt/solarized-everything-css/css/apprentice/apprentice-all-sites.css ""')
config.bind(',dr', 'config-cycle content.user_stylesheets ~/opt/solarized-everything-css/css/darculized/darculized-all-sites.css ""')
config.bind(',gr', 'config-cycle content.user_stylesheets ~/opt/solarized-everything-css/css/gruvbox/gruvbox-all-sites.css ""')
config.bind(',sd', 'config-cycle content.user_stylesheets ~/opt/solarized-everything-css/css/solarized-dark/solarized-dark-all-sites.css ""')
config.bind(',sl', 'config-cycle content.user_stylesheets ~/opt/solarized-everything-css/css/solarized-light/solarized-light-all-sites.css ""')

#  c.bindings.commands = {"normal":{",m": "hint links spawn mpv {hint-url}", ",p": "spawn --userscript qute-lastpass"}}
